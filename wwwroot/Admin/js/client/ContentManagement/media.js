...
$(document).ready(function () {
	...
	BindImageUploader("#GarageSecondarylogo", "#image", "#CropperModal", "#PreviewSecondaryImage");

	BindImageUploader("#GarageThumbnailImage", "#image", "#CropperModal", "#PreviewThumbnailImage");

	BindImageUploader("#FooterBanner", "#image", "#CropperModal", "#FooterBannerPreview");
	BindImageUploader("#InnerPagesBanner", "#image", "#CropperModal", "#InnerPagesBannerPreview");
	BindImageUploader("#Favicon", "#image", "#CropperModal", "#PreviewFavicon");
	...
	$('.theme-link.data').click(function () {
		...
		} else if ($(this).closest('.card').hasClass('Title-section')) {
...
function SaveContent(element, content) {
	...
	$.ajax({
		url: "/Client/ContentManagement/Edit/",
		type: "POST",
		processData: false,
		contentType: false,
		data: data,
...
function SaveThemeColor(element) {
	...
	$.ajax({
		url: "/Client/ContentManagement/UpdateThemeColor/",
		type: "POST",
		processData: false,
		contentType: false,
		data: data,
