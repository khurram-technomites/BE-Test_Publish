...
$(document).ready(function () {
    ...
    //    debugger;
    //    var couponCode = $('input[type="text"]').val();
    //    var data= {
    //        CouponCode: couponCode
    //    }
    //    $.ajax({
    //        url: "/Vendor/Client/CouponValidation",
    //        type: "POST",
    //        data: { 'coupon': data },
    ...
    //    $('input[type="text"]').val('');
    //    $('.check-btn').removeAttr('hidden', 'hidden');
    //    $('.remove-btn').hide();
    //    $('#couponcode').val('')
...
function savePackage(element){
    ...
    var data = {
        ...
        ClientModulePurchases: {
            ...
            CouponDiscountAmount: $('#CouponDiscountAmount').val(),
            CouponDiscountPercentage: $('#CouponDiscountPercentage').val()
        }
    }
