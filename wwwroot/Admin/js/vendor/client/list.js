        ...
        table1 = table.DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    width: '130px',
                    render: function (data, type, full, meta) {
                        return  `<button type="button" class="btn btn-outline-primary mr-1" onclick='ClientLogin(this,"${data}")'>Login</button>`;
...
function ClientLogin(element, record) {

    swal.fire({
        title: 'Are you sure?',
        text: "You want to Login to this Client!",
        type: 'warning',
        showCancelButton: true,
        ...
        if (result.value) {
            ...
            $.ajax({
                url: '/Vendor/Client/ClientLogin?Email='+ record,
                type: 'GET',
                data: {
                    "__RequestVerificationToken":
                        $("input[name=__RequestVerificationToken]").val()
