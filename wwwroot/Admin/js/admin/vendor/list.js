        ...
        table1 = table.DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    width: '130px',
                    render: function (data, type, full, meta) {
                        return `<button type="button" class="btn btn-outline-primary mr-1" onclick='VendorLogin(this,"${data}")'>Login</button>`;
...
function VendorLogin(element, record) {
    ...
    swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                url: '/Admin/Vendor/VendorLogin?Email=' + record,
                type: 'GET',
                data: {
