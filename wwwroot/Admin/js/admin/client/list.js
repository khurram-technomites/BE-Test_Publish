            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        debugger
                        actions +=
                            '<a class="btn btn-bg-secondary btn-icon btn-sm mr-1" href="/Admin/Client/Finalize/' + data + '" title="tasks">' +
                        ...
                        actions +=
                            '<a class="btn btn-bg-secondary btn-icon btn-sm mr-1" href="/Admin/Client/TaskComplete/' + data + '" title="Finalize">' +
                            '<i class="fa fa-tasks"></i>' +
                            '</a> ';
                         }
                        actions +=

                            '<a class="btn btn-bg-secondary btn-icon btn-sm mr-1" href="/Admin/Client/Edit/' + data + '" title="Edit">' +
                            '<i class="fa fa-pen"></i>' +
                            '</a> ';
                        ...
                        if (status === 'PROCESSING') {
                            actions += `<button type="button" class="btn btn-sm mr-1 btn-outline-success mt-3" onclick='activeChange(this,true,${UserId})'>`;
                            actions += '<i class="fa fa-check-circle" aria-hidden="true"></i> Approve</button>';
                            actions += `<button type="button" class="btn btn-sm mr-1 btn-outline-danger mt-3" onclick='Reject(this,false,${UserId})'>`;
                            ...
                            actions += `<button type="button" class="btn btn-sm mr-1 btn-outline-danger mt-3" onclick='activeChange(this,false,${UserId})'>`;
                ...
                //},
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        return ' <button onclick="OpenModelPopup(this,\'/Admin/Client/ClientPurchases/' + data + '\',true)" style="background-color:#00A2A4; color:white" class="btn  ml-auto">Purchases</button>';
